...
<div class="space-y-6 dark:space-y-8">
    ...
    <div class="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-4 md:gap-6">
        ...
        <div class="bg-white dark:bg-gray-800 rounded-xl shadow-sm overflow-hidden border border-gray-100 dark:border-gray-700 hover:shadow-md transition-all duration-300 group">
            <div class="p-4 md:p-5 flex items-start justify-between">
                <div>
                    ...
                    <h3 class="text-xl md:text-2xl font-bold mt-1 text-gray-800 dark:text-white">1,842</h3>
        ...
        <div class="bg-white dark:bg-gray-800 rounded-xl shadow-sm overflow-hidden border border-gray-100 dark:border-gray-700 hover:shadow-md transition-all duration-300 group">
            <div class="p-4 md:p-5 flex items-start justify-between">
                <div>
                    ...
                    <h3 class="text-xl md:text-2xl font-bold mt-1 text-gray-800 dark:text-white">356</h3>
                    <p class="text-xs mt-2">
        ...
        <div class="bg-white dark:bg-gray-800 rounded-xl shadow-sm overflow-hidden border border-gray-100 dark:border-gray-700 hover:shadow-md transition-all duration-300 group">
            <div class="p-4 md:p-5 flex items-start justify-between">
                <div>
                    ...
                    <h3 class="text-xl md:text-2xl font-bold mt-1 text-gray-800 dark:text-white">1,024</h3>
                    <p class="text-xs mt-2">
        ...
        <div class="bg-white dark:bg-gray-800 rounded-xl shadow-sm overflow-hidden border border-gray-100 dark:border-gray-700 hover:shadow-md transition-all duration-300 group">
            <div class="p-4 md:p-5 flex items-start justify-between">
                <div>
                    <p class="text-xs md:text-sm font-medium text-gray-500 dark:text-gray-400">الإيرادات الشهرية</p>
                    <h3 class="text-xl md:text-2xl font-bold mt-1 text-gray-800 dark:text-white">$24,580</h3>
                    <p class="text-xs mt-2">
                        <span class="text-green-500 dark:text-green-400 font-medium">↑ 18.2%</span>
                        <span class="text-gray-500 dark:text-gray-400"> عن الشهر الماضي</span>
                    </p>
                </div>
                <div class="bg-amber-50 dark:bg-amber-900/30 p-2 md:p-3 rounded-lg group-hover:scale-110 transition-transform duration-300">
                    <svg xmlns="http://www.w3.org/2000/svg" class="h-6 w-6 md:h-8 md:w-8 text-amber-600 dark:text-amber-400" fill="none" viewBox="0 0 24 24" stroke="currentColor">
                        <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M12 8c-1.657 0-3 .895-3 2s1.343 2 3 2 3 .895 3 2-1.343 2-3 2m0-8c1.11 0 2.08.402 2.599 1M12 8V7m0 1v8m0 0v1m0-1c-1.11 0-2.08-.402-2.599-1M21 12a9 9 0 11-18 0 9 9 0 0118 0z" />
                    </svg>
                </div>
            </div>
            <div class="h-1 md:h-2 bg-gradient-to-r from-amber-500 to-amber-300 dark:from-amber-600 dark:to-amber-400"></div>
        </div>
    </div>
