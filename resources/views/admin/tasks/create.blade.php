...
<div class="container mx-auto p-6">
    <div class="mb-6">
        <h1 class="text-3xl font-bold text-gray-900 dark:text-white transition-colors duration-300">إضافة مهمة جديدة</h1>
    </div>

    <div class="bg-white dark:bg-gray-800 p-6 rounded-lg shadow-lg transition-colors duration-300">
        <form action="{{ route('admin.tasks.store') }}" method="POST" novalidate>
            @csrf
            ...
            <div class="mb-4">
                ...
                <input 
                    type="datetime-local" id="deadline" name="deadline" value="{{ old('deadline') }}"
                    class="w-full p-2 rounded border 
                           border-gray-300 dark:border-gray-600 
                           bg-gray-50 dark:bg-gray-900 
                           text-gray-900 dark:text-white 
